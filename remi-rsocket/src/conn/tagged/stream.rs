...
/// A type to represent a stream of [`super::TaggedConnection`] connection.
#[derive(Debug)]
...
impl crate::conn::RStream for TaggedStream {
...
impl From<Lane<StreamId, Frame>> for TaggedStream {
